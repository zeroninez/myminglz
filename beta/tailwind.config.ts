...
module.exports = {
  ...
  theme: {
    backgroundImage: {
      'primary-gradient': 'radial-gradient(147.78% 147.78% at 11.86% 10.4%, #A3E635 0%, #70EFA3 100%)', // background
      'sheet-gradient': 'linear-gradient(180deg, rgba(21, 21, 21, 0.80) 0%, rgba(90, 90, 90, 0.80) 100%)',
    },
    fontSize: {
      xxxs: '0.6rem',
      xxs: '0.65rem',
